...
public class AirportService {
    ...
    public List<Airport> findAllWithRelationships(Pageable pageable) {
		//List<Airport> airports = airportRepository.findByAllWithAddressAndDepartures(pageable);
		//airports = airportRepository.findByAllWithArrivals(pageable);

		List<Airport> airports = airportRepository.findByAllWithAddress(pageable);
